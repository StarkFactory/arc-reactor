...
[ ] 5. TaskList(없으면 §2 우선순위 표)에서 다음 우선 작업 선택 (in_progress 마킹)
[ ] 6. chosen_axis / current_gap / expected_delta / evidence_paths 기록
[ ] 7. 대상 파일 전부 Read
...
[ ] 14. TaskList 완료 마킹(없으면 최근 Round에 상태 기록), 다음 Round 후보 정리
```
