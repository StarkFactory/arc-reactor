...
class SystemPromptBuilderTest {
    ...
    fun `keyword search prompts에 대해 add confluence discovery instruction해야 한다`() {
        ...
        assertTrue(prompt.contains("MUST call `confluence_search_by_text` or `confluence_search`")) {
            "Confluence discovery prompts should force confluence_search_by_text or confluence_search"
        }
    }
