...
[![Version](https://img.shields.io/badge/version-5.1.0-blue.svg)](https://github.com/StarkFactory/arc-reactor/releases/tag/v5.1.0)
...
사용 가능한 태그: 정확한 버전(예: `4.8.0`), 마이너 스트림(예: `4.8`), 짧은 SHA(`sha-<commit>`).
