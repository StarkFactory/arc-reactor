...
| File | Description |
|------|-------------|
| [`SemanticToolSelector.kt`](../../src/main/kotlin/com/arc/reactor/tool/SemanticToolSelector.kt) | Embedding-based tool selection |
| [`AgentProperties.kt`](../../src/main/kotlin/com/arc/reactor/agent/config/AgentProperties.kt) | ToolSelectionProperties configuration |
| [`ArcReactorAutoConfiguration.kt`](../../src/main/kotlin/com/arc/reactor/autoconfigure/ArcReactorAutoConfiguration.kt) | Auto-configuration of SemanticToolSelector |
| [`ToolSelector.kt`](../../src/main/kotlin/com/arc/reactor/tool/ToolSelector.kt) | ToolSelector interface |
| [`ToolCategory.kt`](../../src/main/kotlin/com/arc/reactor/tool/ToolCategory.kt) | Keyword-based category system (comparison) |
