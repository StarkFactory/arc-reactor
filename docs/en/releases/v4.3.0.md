...
- **Security hardening (P0)**:
  - JWT secret validated at startup — fails fast when secret is empty or shorter than 32 bytes.
...
- JWT secret validation is a startup gate — ensure `arc.reactor.auth.jwt-secret` is ≥ 32 bytes.
