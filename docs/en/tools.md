...
> Example code: [`WeatherTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/WeatherTool.kt)
...
> Example code: [`CalculatorTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/CalculatorTool.kt), [`DateTimeTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/DateTimeTool.kt)
...
From the agent's perspective, all four are identical tools. For details, see the [Supervisor Pattern Guide](./supervisor-pattern.md).
...
| File | Description |
|------|-------------|
| [`ToolCallback.kt`](../src/main/kotlin/com/arc/reactor/tool/ToolCallback.kt) | Tool interface |
| [`LocalTool.kt`](../src/main/kotlin/com/arc/reactor/tool/LocalTool.kt) | Spring AI annotation marker |
| [`ToolCategory.kt`](../src/main/kotlin/com/arc/reactor/tool/ToolCategory.kt) | Tool classification system |
| [`ToolSelector.kt`](../src/main/kotlin/com/arc/reactor/tool/ToolSelector.kt) | Tool filtering |
| [`McpManager.kt`](../src/main/kotlin/com/arc/reactor/mcp/McpManager.kt) | MCP server management |
| [`CalculatorTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/CalculatorTool.kt) | ToolCallback implementation example |
| [`WeatherTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/WeatherTool.kt) | LocalTool implementation example |
| [`WorkerAgentTool.kt`](../src/main/kotlin/com/arc/reactor/agent/multi/WorkerAgentTool.kt) | Adapter that wraps an agent as a tool |
