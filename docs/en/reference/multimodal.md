...
| File | Description |
|------|-------------|
| [`AgentModels.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/agent/model/AgentModels.kt) | MediaAttachment data class, AgentCommand.media field |
| [`MediaConverter.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/agent/model/MediaConverter.kt) | Converts MediaAttachment to Spring AI Media |
| [`ChatController.kt`](../../../arc-web/src/main/kotlin/com/arc/reactor/controller/ChatController.kt) | JSON endpoint (mediaUrls) and multipart endpoint |
