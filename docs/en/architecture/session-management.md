...
- [`controller/SessionController.kt`](../../../arc-web/src/main/kotlin/com/arc/reactor/controller/SessionController.kt) -- Session/model API
- [`controller/PersonaController.kt`](../../../arc-web/src/main/kotlin/com/arc/reactor/controller/PersonaController.kt) -- Persona CRUD API
- [`controller/ChatController.kt`](../../../arc-web/src/main/kotlin/com/arc/reactor/controller/ChatController.kt) -- System prompt resolution logic
- [`memory/ConversationMemory.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/memory/ConversationMemory.kt) -- MemoryStore interface
- [`memory/ConversationManager.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/memory/ConversationManager.kt) -- Conversation history lifecycle
- [`persona/PersonaStore.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/persona/PersonaStore.kt) -- PersonaStore interface + InMemory implementation
- [`persona/JdbcPersonaStore.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/persona/JdbcPersonaStore.kt) -- PostgreSQL implementation
- [`V1__create_conversation_messages.sql`](../../../arc-core/src/main/resources/db/migration/V1__create_conversation_messages.sql) -- Conversation table
- [`V2__create_personas.sql`](../../../arc-core/src/main/resources/db/migration/V2__create_personas.sql) -- Persona table
