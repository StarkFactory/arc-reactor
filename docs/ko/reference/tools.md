...
> 예시 코드: `CalculatorTool.kt` (삭제됨), `DateTimeTool.kt` (삭제됨)
...
| (삭제됨) | LocalTool | ToolCallback | MCP 도구 |
|---|---|---|---|
...
| `CalculatorTool.kt` (삭제됨) | ToolCallback 구현 예시 |
| `WeatherTool.kt` (삭제됨) | LocalTool 구현 예시 |
