...
| 파일 | 설명 |
|------|------|
| [`ToolApprovalPolicy.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/approval/ToolApprovalPolicy.kt) | 정책 인터페이스 + 기본 제공 구현체 |
| [`ApprovalModels.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/approval/ApprovalModels.kt) | PendingApproval, ApprovalResult 데이터 클래스 |
| [`PendingApprovalStore.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/approval/PendingApprovalStore.kt) | CompletableDeferred 기반 승인 저장소 |
| [`ApprovalController.kt`](../../../arc-web/src/main/kotlin/com/arc/reactor/controller/ApprovalController.kt) | 승인 관리 REST API |
| [`SpringAiAgentExecutor.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/agent/impl/SpringAiAgentExecutor.kt) | checkToolApproval() 통합 지점 |
| [`AgentProperties.kt`](../../../arc-core/src/main/kotlin/com/arc/reactor/agent/config/AgentProperties.kt) | ApprovalProperties 설정 |
