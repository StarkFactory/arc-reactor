...
- Generated at: `2026-03-07T22:35:06.156037+00:00`
- Validation run id: `20260307T221120Z+personalized-refresh`
...
| employee-value | 213 | 92 | 121 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| knowledge-discovery | usable | 100% | 52 | 0 | 52 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| ownership-discovery | usable | 100% | 10 | 2 | 8 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| personalized | usable | 100% | 42 | 37 | 5 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| policy-process | usable | 100% | 68 | 9 | 59 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| project-operational | usable | 100% | 28 | 28 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| repository-operational | usable | 100% | 12 | 12 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| swagger | usable | 92% | 13 | 12 | 0 | 0 | 0 | 1 | 0 | 0 | 0 | 0 |
| swagger-consumer | usable | 100% | 8 | 8 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| team-status | usable | 100% | 24 | 24 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
- Confluence에서 '근무시간' 키워드로 검색하고 관련 정책 문서가 있으면 링크와 함께 알려줘.
- '야근' 관련 사내 규정이 있으면 Confluence 기준으로 요약해줘. 없으면 없다고 알려줘.
...
- `confluence_search_by_text`: `147`
- `jira_search_issues`: `21`
- `work_morning_briefing`: `18`
- `spec_load`: `13`
- `jira_search_by_text`: `12`
- `jira_blocker_digest`: `11`
- `jira_due_soon_issues`: `11`
- `work_release_risk_digest`: `11`
- `work_personal_focus_plan`: `11`
- `bitbucket_review_queue`: `9`
- `spec_list`: `8`
- `work_personal_learning_digest`: `8`
- `work_prepare_standup_update`: `7`
- `bitbucket_stale_prs`: `6`
- `bitbucket_review_sla_alerts`: `6`
...
| policy-process-136 | employee-value | policy-process | no_result | no_result_good | Y | 1 | confluence_search_by_text | '릴리즈 체크리스트' 관련 사내 규정이 있으면 Confluence 기준으로 요약해줘. 없으면 없다고 알려줘. |
...
| policy-process-143 | employee-value | policy-process | no_result | good | Y | 1 | confluence_search_by_text | Confluence에서 '근무시간' 키워드로 검색하고 관련 정책 문서가 있으면 링크와 함께 알려줘. |
...
| policy-process-148 | employee-value | policy-process | no_result | good | Y | 1 | confluence_search_by_text | '야근' 관련 사내 규정이 있으면 Confluence 기준으로 요약해줘. 없으면 없다고 알려줘. |
...
| policy-process-155 | employee-value | policy-process | no_result | good | Y | 1 | confluence_search_by_text | Confluence에서 '권한 신청' 키워드로 검색하고 관련 정책 문서가 있으면 링크와 함께 알려줘. |
...
| policy-process-174 | employee-value | policy-process | no_result | good | Y | 1 | confluence_search_by_text | '재택 장비' 관련 사내 규정이 있으면 Confluence 기준으로 요약해줘. 없으면 없다고 알려줘. |
