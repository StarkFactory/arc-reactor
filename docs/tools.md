...
> 예시 코드: [`WeatherTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/WeatherTool.kt)
...
> 예시 코드: [`CalculatorTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/CalculatorTool.kt), [`DateTimeTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/DateTimeTool.kt)
...
에이전트 입장에서는 4개 다 똑같은 도구입니다. 자세한 내용은 [Supervisor 패턴 가이드](./supervisor-pattern.md)를 참고하세요.
...
| 파일 | 설명 |
|------|------|
| [`ToolCallback.kt`](../src/main/kotlin/com/arc/reactor/tool/ToolCallback.kt) | 도구 인터페이스 |
| [`LocalTool.kt`](../src/main/kotlin/com/arc/reactor/tool/LocalTool.kt) | Spring AI 어노테이션 마커 |
| [`ToolCategory.kt`](../src/main/kotlin/com/arc/reactor/tool/ToolCategory.kt) | 도구 분류 시스템 |
| [`ToolSelector.kt`](../src/main/kotlin/com/arc/reactor/tool/ToolSelector.kt) | 도구 필터링 |
| [`McpManager.kt`](../src/main/kotlin/com/arc/reactor/mcp/McpManager.kt) | MCP 서버 관리 |
| [`CalculatorTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/CalculatorTool.kt) | ToolCallback 구현 예시 |
| [`WeatherTool.kt`](../src/main/kotlin/com/arc/reactor/tool/example/WeatherTool.kt) | LocalTool 구현 예시 |
